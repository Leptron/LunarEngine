...
namespace LunarRenderer {
	...
	LunarShader::LunarShader(const char* vertexPath, const char* fragmentPath) {
		...
		try {
			...
			//read the files buffer into the stream
	...
	void LunarShader::setBool(const std::string& name, bool value) const {
		glUniform1i(glGetUniformLocation(ID, name.c_str()), (int)value);
	}

	void LunarShader::setInt(const std::string& name, int value) const {
